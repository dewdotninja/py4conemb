# iot_controller4_oop_usrcmd.py
# dew.ninja  Oct 2023
# OOP and multitask version of iot_controller4.py

# multitask (Oct 2023)
# move netpie communication to thread and add local user command
# to main loop
...
# --- these functions are moved to NETPIE object ------
# def wifi_connect():
...
#           # Update : use filter node to fix this ---
...
def do_netpie_comm_forever():
    while True:
        netpie_comm()
        time.sleep(1)
        
# start a new thread
_thread.start_new_thread(do_netpie_comm_forever,())
