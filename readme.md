...
อิกวิธีการหนึ่งที่สามารถใช้ในการวางแผนเส้นทางหุ่นยนต์ในกรณีที่ไม่ทราบโมเดล คือวิธี Q-learning ซึ่งไม่ได้ครอบคลุมในเนื้อหาของหนังสือนี้ แต่สามารถเขียนโค้ดเองได้โดยไม่ยาก ดังแสดงตัวอย่างในโน๊ตบุคนี้ [ddtk_gw6x6_qlearn.ipynb](/code/chapter8/notebooks/q-learning/ddtk_gw6x6_qlearn.ipynb)
